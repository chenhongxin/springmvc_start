...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.itcast.ssm.webservice.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.itcast.ssm.webservice.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns com.itcast.ssm.webservice.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.itcast.ssm.webservice.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.itcast.ssm.webservice.GetDatabaseInfoResponse")
